...
class TaskA2 {
    public static void main(String[] args) {
        ...
        String b="И труд нелеп, и бестолкова праздность,";
        String c="И с плеч долой всё та же голова,";
        String d="Когда приходит бешеная ясность,";
        String f="Насилуя притихшие слова.";
