...
1. Инициализация. Нажмите Fork на странице https://github.com/itacad/CS2019-11-12/
2. У вас в аккаунте fork появится тут  https://github.com/ваш_логин/CS2019-11-12
3. Выберите в IDEA VCS -> Checkout version control -> GitHub и затем:
 * укажите ссылку на Ваш fork https://github.com/ваш_логин/CS2019-11-12;
 * выберите путь к папке проекта (без русских букв и пробелов);
 * укажите имя папки проекта (например CS2019-11-12_verXX - такой папки на диске быть не должно).
 * добавьте второй источник VCS -> Git -> Remote -> (+)
 * имя источника: upstream , URL: https://github.com/itacad/CS2019-11-12/
